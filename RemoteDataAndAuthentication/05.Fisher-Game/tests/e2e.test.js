...
const host = 'http://127.0.0.1:5500/Advanced/JSApplications/RemoteDataAndAuthentication/05.Fisher-Game/index.html'; // Application host (NOT service host - that can be anything)
