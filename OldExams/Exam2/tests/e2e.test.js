...
const userApplicationHttpPort = "";

const host = "http://127.0.0.1:5500/Advanced/JSApplications/OldExams/Exam2"; // Application host (NOT service host - that can be anything)
const interval = 200;
const DEBUG = false;
